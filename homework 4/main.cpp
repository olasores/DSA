...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      GroceryStore::ShoppingCarts shoppingCarts = myStore.makeShoppingCarts(); 
    ...
    ///////////////////////// TO-DO (3) //////////////////////////////
      ...
      GroceryStore::GroceryItemsSold allSales = myStore.ringUpCustomers(shoppingCarts); 
