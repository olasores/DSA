...
class GroceryItemDatabase
{
  ...
  private:
    ...
    ///////////////////////// TO-DO (2) //////////////////////////////
      ...
      std::vector<GroceryItem>  groceryItem; 
      // using an iterator to find the item in the databasssssee
      GroceryItem * find(const std::string &upc, std::vector<GroceryItem>::iterator &iter);
    /////////////////////// END-TO-DO (2) ////////////////////////////
};
