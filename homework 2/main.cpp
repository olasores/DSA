...
int main()
{
  try
  {
    ...
    ///////////////////////// TO-DO (1) //////////////////////////////
     ...
     // Use all the functions of the GroceryList interface, including the insertion, extraction, and relational operators.
        // by calling the function in main

     // Try inserting grocery items from both the top and the bottom of the lists using the enumerated position values TOP and BOTTOM as well as indexed offsets.


      // Create, manipulate, and display your own GroceryList object here.
       const GroceryList myPastaList = {{"pasta", "Barilla"}, 
                                 {"Sauce", "Ragu"},
                                 {"meat", "ground beef"}, 
                                 {"vegetables", "bell pepperrs"}, 
                                 {"fruit", "mangoes"}};
                                 
        std::cout << "My Grocery List" << myPastaList << "\n\n";                         

      // //  // inserting items from both the top and the bottom of the lists using the enumerated position values TOP and BOTTOM as well as indexed offsets.
      // myPastaList.insert(GroceryItem("pasta", "Barilla"), GroceryList::TOP);
      // myPastaList.insert("Sauce", "Ragu", GroceryList::Position::TOP);
        /// I DO NOT KNOW HOW
      // myPastaList.insert(GroceryItem("fruit", "mangoes"), GroceryList::BOTTOM);
      // myPastaList.insert(GroceryItem("vegetables", "bell peppers"), 2);
      // myPastaList.insert(GroceryItem("meat", "ground beef"), 3);
      // // Remove grocery items from the top, middle, and bottom.
      // myPastaList.remove(GroceryItem("pasta", "Barilla"));
      // myPastaList.remove(GroceryItem("fruit", "mangoes"));
      // myPastaList.remove(GroceryItem("vegetables", "bell peppers"));
      // myPastaList.remove(GroceryItem("meat", "ground beef"));
      // Create, concatenate, rearrange, and compare several (more than two) lists.
